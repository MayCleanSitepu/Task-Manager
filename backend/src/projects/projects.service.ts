...
export class ProjectsService {
  ...
  async findAll(user: { sub: string, role: string }, search?: string, skip?: number, take?: number) {
  ...
  async update(id: string, updateProjectDto: UpdateProjectDto, user: { sub: string, role: string }) {
